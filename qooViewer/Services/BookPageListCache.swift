...
actor BookPageListCache {
    ...
    struct Entry: Codable, Sendable {
        ...
        ///    捨てて読み直すこと。
        ///    なお、環境設定「並び順をFinderに揃える」(2026-09-13に撤去)の値はここには
        ///    入らなかった。あの設定は表示直前にEffectivePageOrderが適用するもので、保存物には
        ///    影響しなかった(PageOrder.swift冒頭の「並び順の全体設計」参照)。
        ...
        /// 4: 書庫の中の隠しファイル・隠しフォルダ(`.hidden/001.jpg`、`.001.jpg`)を
        ///    ページとして数えるのをやめた(isHiddenArchiveEntry参照)。版3までのJSONには
        ///    そのページが残っているため、版3と同じ理由で捨てて読み直すこと。
