...
nonisolated enum StoreSchemaGuard {
    ...
    ///   足した時点(2026-09-21、ファイル名の解析を qooMeta へ置き換えたとき)。**リリース前のブランチで
    ///   スマートライブラリのモデルを足したら、この行の指紋を書き換えてよい**(まだ誰のストアもこの世代を記録していない)
    static let generations: [Int: String] = [
        1: "82a1fb6d0d07bdc10cc4f297ac78096f48f6d101c0d8ec685ede6c0e803429d2",
        2: "2a255f7884b7b89d9b1077d4b7291380fbcfb4fcb1a8701a82867e03192c4e4d",
    ]
