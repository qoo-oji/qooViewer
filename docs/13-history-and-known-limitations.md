...
- ~~スマートライブラリの前回の一覧(`catalog.json`)を先に出せていない~~ → 2026-09-26 に直した(読み込みが、同時に始まる
  集め直しの `generation += 1` で毎回捨てられていた。作った 2026-09-22 から効いていなかった)。経緯は
  [plans/efficiency-audit-2026-09-25.md](plans/efficiency-audit-2026-09-25.md)「直したもの: 前回の一覧を先に出す」。
