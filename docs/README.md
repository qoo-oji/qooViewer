...
| 15 | [15-file-browser.md](15-file-browser.md) | ホームのファイルブラウザ(改善要望7)。構成・操作エンジンと取り消し・一覧の読み込みと移動の規則・書く操作と読み取り専用モード・一括リネーム・圧縮展開・サムネイル・既存機能との接続・サンドボックスと TCC の約束・保存するもの・既知の制限 |
