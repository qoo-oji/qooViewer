...
| `AppearanceSettingsTests` | 外観タブの設定一式(2026-09-22)―― ノーマル/シークレットの 2 揃いとも全設定が保存・開き直し・「初期設定に戻す」できること(総なめ)、揃いごとのキー(ノーマルは従来のキー)、片方を動かしても戻してももう片方が動かないこと、「別の外観を使う」の初回だけノーマルから写すこと |
